# Source: https://github.com/vllm-project/tpu-inference/blob/main/tpu_inference/kernels/experimental/gmm_v2/gmm_v2.py
      ...
      for start_n in range(0, rhs_tile_n, mxu_size):
        ...
        for start_k in range(0, cfgs.tiles.tile_k, rhs_step_k):
          ...
          if (
              ...
              and not cfgs.rhs_cfgs.should_dequantize_before_matmul
          ):
