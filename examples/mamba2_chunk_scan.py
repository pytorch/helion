...
def test(
    ...
    INIT = {
        "r": functools.partial(torch.randn, dtype=dtype, device="cuda"),
        "u": functools.partial(torch.rand, dtype=dtype, device="cuda"),
        "z": functools.partial(torch.zeros, dtype=dtype, device="cuda"),
        "o": functools.partial(torch.ones, dtype=dtype, device="cuda"),
    }
