...
class Config(Mapping[str, object]):
    ...
    def __init__(
        ...
        *,
        ...
        advanced_compiler_configuration: str | None = None,
        ...
        **kwargs: object,
        ...
        Args:
            ...
            advanced_compiler_configuration: Path to a PTXAS control file applied during compilation, or empty string for none.
    ...
    @property
    def advanced_compiler_configuration(self) -> str:
        return cast("str", self.config.get("advanced_compiler_configuration", ""))
