...
BackendLiteral = Literal["triton", "pallas", "cutedsl"]
...
def _get_backend() -> BackendLiteral:
    return _env_get_literal(
        ...
        mapping={"triton": "triton", "pallas": "pallas", "cutedsl": "cutedsl"},
    )
...
class Settings(_Settings):
    ...
    __slots__ = {
        "backend": (
            ...
            "or 'cutedsl' (NVIDIA CuteDSL/CUTLASS). "
            "Set HELION_BACKEND=cutedsl to use the CuteDSL backend."
        ),
        "ignore_warnings": (
