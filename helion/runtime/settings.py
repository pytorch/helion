...
class Settings(_Settings):
    ...
    __slots__ = {
        ...
        "specialize_zero_one": (
            "If True, automatically specialize tensor dimensions of size 0 or 1 as constants. "
            "This can cause recompilation when shapes change between 0/1 and larger values. "
            "Set HELION_SPECIALIZE_ZERO_ONE=0 to disable."
        ),
