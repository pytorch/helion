...
See the module docstring for the architecture overview; the
``_FastLauncher`` docstring explains the multi-spec cache; the
profiling write-up in ``agent_space/fast_launcher_profiling.md``
breaks down per-operation savings.
"""
