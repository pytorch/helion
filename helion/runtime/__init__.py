...
def default_launcher(
    ...
    **kwargs: dict,
    ...
    """Triton launcher with Helion-friendly shape-mismatch diagnostics.
    ...
    :class:`helion.exc.ShapeMismatch`. Generated kernels import this; the
    precompiler inlines the dependency-free base instead. The signature mirrors
    the base so the launcher contract stays explicit for both callers.
    """
    try:
