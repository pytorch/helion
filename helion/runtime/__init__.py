...
def default_metal_launcher(
    ...
    **kwargs: object,
    ...
    The ``metal_kernel`` is a ``@metal_jit`` decorated function that returns
    a compiled Metal shader library on first call (cached thereafter).
    ...
    lib, kernel_name = metal_kernel()  # type: ignore[operator]
