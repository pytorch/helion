    ...
    *,
    ...
    if _matmul_dot_general is not None:
        ...
        if needs_pipeline_specs:
            ...
            # was populated with ``_pipeline_arg_indices`` above, so the
            ...
            if _pipeline_arg_indices and pallas_aliases:
                hbm_alias = {
                    in_pos: out_pos
                    for in_pos, out_pos in pallas_aliases.items()
                    if in_pos in set(_pipeline_arg_indices)
                }
                if hbm_alias:
...
def default_pallas_launcher(
    ...
    **kwargs: object,
    ...
    ``_pipeline_arg_indices`` kwargs the pipeline launcher uses.
    """
