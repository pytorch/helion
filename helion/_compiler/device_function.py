...
class DeviceFunction:
    ...
    def codegen_function_def(self) -> list[ast.stmt]:
        ...
        # Append fusion extra params before rng_seed_buffer to match call order
        # (codegen_function_call extends args with extra_params before
        # build_launcher_args appends rng_seed).
    ...
    def dead_code_elimination(self) -> None:
        ...
        # The assertion in generate_ast.py verifies this removal happened.
        args_to_remove = {
            arg.name
