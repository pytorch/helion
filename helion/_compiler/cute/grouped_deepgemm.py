...
def _compile_blackwell_grouped_kernel(
    ...
    *,
    ...
    dim_tensor, dim_torch = cutlass_torch.cute_tensor_like(
        torch.tensor(metadata.problems, dtype=torch.int32),
        cutlass.Int32,
        is_dynamic_layout=False,
        assumed_align=16,
    )
    stride_tensor, stride_torch = cutlass_torch.cute_tensor_like(
        torch.tensor(metadata.strides_abc, dtype=torch.int32),
        cutlass.Int32,
        is_dynamic_layout=False,
        assumed_align=16,
    )
    ...
    tensormap, tensormap_torch = cutlass_torch.cute_tensor_like(
