...
def _ensure_inductor_fusion_config(tx: InstructionTranslator) -> None:
    ...
    A sentinel attribute prevents unbounded wrapping.
    """
    ...
    if getattr(inner, "_helion_fusion_wrapped", False):
        return
    ...
    wrapped._helion_fusion_wrapped = True  # type: ignore[attr-defined]
