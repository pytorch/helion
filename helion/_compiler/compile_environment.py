...
class CompileEnvironment:
    ...
    def __init__(
        ...
        *,
        ...
        # Config-independent analysis shared by a heuristic's fact, eligibility,
        # and seed-generation phases. This is tracing state and is never serialized.
        self.compiler_heuristic_state: dict[str, object] = {}
