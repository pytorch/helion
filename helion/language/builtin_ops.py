...
from .._compiler.compile_environment import get_concrete_hint
from .._compiler.compile_environment import to_sympy_expr
...
def compute_symbolic_min_max(
    ...
    expr = to_sympy_expr(args[0])
    hint = get_concrete_hint(args[0], env)

    for arg in args[1:]:
        rhs_expr = to_sympy_expr(arg)
        rhs_hint = get_concrete_hint(arg, env)
