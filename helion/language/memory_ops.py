...
def _codegen_cute_store_tcgen05_tile(
    ...
    # N,M-oriented grouped matmuls expose a transposed accumulator/source view,
    # but their D TMA descriptor is still built for the physical (BM, BN) tile.
    # The generic compact-fragment destination dimensions are correct for MN
    # stores; applying them to NM stores swaps the descriptor twice.
