...
# Type alias for valid index types in PyTorch
TensorIndex = int | slice | torch.Tensor | torch.SymInt | type(None) | type(...)
...
def store(
    tensor: torch.Tensor,
    index: Sequence[TensorIndex],  # type: ignore[valid-type]
