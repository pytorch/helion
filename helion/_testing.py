...
class TestCase(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        if is_mtia():
            ...
            import mtia.host_runtime.torch_mtia.dynamic_library  # type: ignore[import-not-found]
            # pyrefly: ignore [missing-import]
            from mtia.re.re_unittest_lib import (
                MTIAUnittest,  # type: ignore[import-not-found]
            )
            # pyrefly: ignore [missing-import]
            from triton_mtia.python.mtia.eager import (
                mtia_triton_launcher,  # type: ignore[import-not-found]
            )
