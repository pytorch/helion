...
def build_layer(args, tensors, shape, geometry, configs, config_path):
    ...
    return {
        ...
        "compiled_kernels": {
            "input_norm": input_norm_kernel,
            "qkv_mm": qkv_mm_kernel,
            "shared_q": shared_q_kernel,
            "shared_q_norm": shared_q_norm_kernel,
            "qkv_norm_rope": norm_kernel,
            "qkv_norm_rope_cache": fused_norm_cache_kernel,
            "cache": cache_kernel,
            "attention": attention_kernel,
            "attention_merge": merge_kernel,
            "o_projection": o_kernel,
            "post_attention": post_attention_kernel,
            "gate_up": gate_up_kernel,
            "geglu": geglu_kernel,
            "down": down_kernel,
            "post_ff": post_ff_kernel,
            "ple_gate": ple_kernel,
            "ple_projection": ple_projection_kernel,
            "final": final_kernel,
        },
        "stage_outputs": {
            "query": query,
