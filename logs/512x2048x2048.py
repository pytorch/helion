# Helion plain scaled_mm for M=512 K=2048 N=2048
# vLLM=5.83us  helion=6.84us  ratio=1.174x  MISS
...
def _helion_scaled_mm(x, y, scale_a, scale_b, out, split_k, _NUM_SM: tl.constexpr, _BLOCK_SIZE_2: tl.constexpr):
    ...
    total_pids = tl.cdiv(512, _BLOCK_SIZE_0) * tl.cdiv(2048, _BLOCK_SIZE_1) * tl.cdiv(2048, _BLOCK_SIZE_2)
