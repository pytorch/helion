...
# Source: vllm/model_executor/layers/quantization/awq_triton.py
"""
AWQ (Activation-aware Weight Quantization) Triton kernels from vLLM.
Supports 4-bit weight quantization with per-group scales and zeros.
"""
import torch
