...
# Source: vllm/model_executor/layers/quantization/compressed_tensors/triton_scaled_mm.py
"""
Triton scaled matmul kernel from vLLM.
Supports per-tensor and per-token quantization with FP8/INT8 inputs.
"""
import torch
