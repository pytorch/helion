...
@helion.kernel(
    static_shapes=True, autotune_effort="quick", _experimental_allow_torch_compile_fusion=True
)
...
@helion.kernel(
    static_shapes=True, autotune_effort="none", _experimental_allow_torch_compile_fusion=True
)
