...
def _require_runtime_cuda13_b200() -> None:
    ...
    if (
        ...
        != pretuned_deepgemm._REVIEWED_AOT_HARDWARE_NAME
    ):
        pytest.skip("reviewed grouped-GEMM profiles require NVIDIA B200")
...
def test_aot_key_distinguishes_b_layout_and_source_tile(
