...
@helion.kernel(config=helion.Config(block_sizes=[32, 32, 32]), dot_precision="ieee")
...
class TestDot(TestCase):
    def setUp(self):
        ...
        self.orig_matmul_allow_tf32 = torch.backends.cuda.matmul.allow_tf32
        self.orig_cudnn_allow_tf32 = torch.backends.cudnn.allow_tf32
        # Disable TF32 for precise IEEE float32 results
        torch.backends.cuda.matmul.allow_tf32 = False
        torch.backends.cudnn.allow_tf32 = False

    def tearDown(self):
        # Restore original TF32 settings
        torch.backends.cuda.matmul.allow_tf32 = self.orig_matmul_allow_tf32
        torch.backends.cudnn.allow_tf32 = self.orig_cudnn_allow_tf32
        super().tearDown()
