...
class TestDot(RefEagerTestBase, TestCase):
    ...
    def test_mm_reshape_m_1(self):
        ...
        self._test_reshape_m_1(
            lambda acc, a, b: acc + torch.mm(a, b), rtol=1e-2, atol=3e-2
        )
    ...
    def test_mm_reshape_k_2(self):
        ...
        self._test_reshape_k_2(lambda acc, a, b: acc + torch.mm(a, b), rtol=1e-2, atol=3e-2)
    ...
    def test_matmul_reshape_m_1(self):
        ...
        self._test_reshape_m_1(
            lambda acc, a, b: acc + torch.matmul(a, b), rtol=1e-2, atol=3e-2
        )
    ...
    def test_matmul_reshape_k_2(self):
        ...
        self._test_reshape_k_2(lambda acc, a, b: acc + torch.matmul(a, b), rtol=1e-2, atol=3e-2)
