...
@triton.jit
def _fn_kernel(out, x, x_size_0, x_size_1, out_stride_0, out_stride_1, x_stride_0, x_stride_1, scale, _BLOCK_SIZE_0_1: tl.constexpr):
...
def fn(x: torch.Tensor):
    ...
    out = torch.empty_like(x)
    _BLOCK_SIZE_0_1 = 32
    _fn_kernel[triton.cdiv(x.size(0) * x.size(1), _BLOCK_SIZE_0_1), 1, 1](out, x, x.size(0), x.size(1), out.stride(0), out.stride(1), x.stride(0), x.stride(1), scale, _BLOCK_SIZE_0_1, num_warps=4, num_stages=3)
    return out
...
def _fn_make_precompiler(x: torch.Tensor):
    ...
    return make_precompiler(_fn_kernel)(out, x, x.size(0), x.size(1), out.stride(0), out.stride(1), x.stride(0), x.stride(1), scale, _BLOCK_SIZE_0_1, num_warps=4, num_stages=3)""",
        )
...
@triton.jit
def _fn_kernel(out, x, x_size_0, out_stride_0, out_stride_1, x_stride_0, x_stride_1, _BLOCK_SIZE_0: tl.constexpr, _BLOCK_SIZE_1: tl.constexpr):
...
def fn(x: torch.Tensor):
    ...
    _BLOCK_SIZE_0 = 32
    _BLOCK_SIZE_1 = 32
    _fn_kernel[triton.cdiv(x.size(0), _BLOCK_SIZE_0) * triton.cdiv(x.size(1), _BLOCK_SIZE_1),](out, x, x.size(0), out.stride(0), out.stride(1), x.stride(0), x.stride(1), _BLOCK_SIZE_0, _BLOCK_SIZE_1, num_warps=4, num_stages=3)
    return out
...
def _fn_make_precompiler(x: torch.Tensor):
    ...
    _BLOCK_SIZE_1 = 32
    from helion.runtime.precompile_shim import make_precompiler
    return make_precompiler(_fn_kernel)(out, x, x.size(0), out.stride(0), out.stride(1), x.stride(0), x.stride(1), _BLOCK_SIZE_0, _BLOCK_SIZE_1, num_warps=4, num_stages=3)""",
        )
...
@triton.jit
def _fn_kernel(out, x, x_size_0, out_stride_0, out_stride_1, x_stride_0, x_stride_1, _BLOCK_SIZE_0: tl.constexpr, _RDIM_SIZE_1: tl.constexpr):
...
def fn(x: torch.Tensor):
    ...
    _BLOCK_SIZE_0 = 32
    _RDIM_SIZE_1 = 512
    _fn_kernel[triton.cdiv(x.size(0), _BLOCK_SIZE_0),](out, x, x.size(0), out.stride(0), out.stride(1), x.stride(0), x.stride(1), _BLOCK_SIZE_0, _RDIM_SIZE_1, num_warps=4, num_stages=3)
    return out
...
def _fn_make_precompiler(x: torch.Tensor):
    ...
    _RDIM_SIZE_1 = 512
    from helion.runtime.precompile_shim import make_precompiler
    return make_precompiler(_fn_kernel)(out, x, x.size(0), out.stride(0), out.stride(1), x.stride(0), x.stride(1), _BLOCK_SIZE_0, _RDIM_SIZE_1, num_warps=4, num_stages=3)""",
        )
...
@triton.jit
def _fn_kernel(out, x, x_size_0, out_stride_0, x_stride_0, x_stride_1, _BLOCK_SIZE_0: tl.constexpr, _RDIM_SIZE_1: tl.constexpr):
    pid_0 = tl.program_id(0)
    offset_0 = pid_0 * _BLOCK_SIZE_0
    indices_0 = (offset_0 + tl.arange(0, _BLOCK_SIZE_0)).to(tl.int32)
    mask_0 = indices_0 < x_size_0
...
def fn(x: torch.Tensor):
    ...
    _BLOCK_SIZE_0 = 32
    _RDIM_SIZE_1 = 512
    _fn_kernel[triton.cdiv(x.size(0), _BLOCK_SIZE_0),](out, x, x.size(0), out.stride(0), x.stride(0), x.stride(1), _BLOCK_SIZE_0, _RDIM_SIZE_1, num_warps=4, num_stages=3)
    return out
...
def _fn_make_precompiler(x: torch.Tensor):
    ...
    _RDIM_SIZE_1 = 512
    from helion.runtime.precompile_shim import make_precompiler
    return make_precompiler(_fn_kernel)(out, x, x.size(0), out.stride(0), x.stride(0), x.stride(1), _BLOCK_SIZE_0, _RDIM_SIZE_1, num_warps=4, num_stages=3)""",
        )
