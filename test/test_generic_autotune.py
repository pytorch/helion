"""Tests for the generic autotuner API (helion.autotuner.generic.autotune).
...
class TestGenericAutotune(TestCase):
    ...
    def test_invalid_algorithm_raises(self):
        ...
        with self.assertRaises(ValueError, msg="Unknown algorithm"):
            autotune(
    ...
    def test_unknown_search_kwarg_raises(self):
        ...
        with self.assertRaises(ValueError, msg="Unknown search kwargs"):
            autotune(
                tunables={"x": IntegerFragment(1, 4, 2)},
                compile_fn=lambda config: lambda a: a,
                baseline_fn=lambda a: a,
