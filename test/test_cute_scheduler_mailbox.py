...
def test_scheduler_aux_consumers_release_all_lanes(
    ...
    # Rank-three SIMT auxiliary operands use the direct-GMEM fallback and
    # leave the extra C-input warp inert; TMA stages them through that warp.
    _assert_all_lane_releases(code, arrivals=(7 if load_mode == "tma" else 6) * 32)
    ...
    assert ("tcgen05_aux_pipeline.consumer_release" in code) == (load_mode == "tma")
