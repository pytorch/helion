...
from helion.autotuner.effort_profile import DIFFERENTIAL_EVOLUTION_DEFAULTS
from helion.autotuner.effort_profile import RANDOM_SEARCH_DEFAULTS
...
class TestDistributed(TestCase, MultiProcessTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls._class_stack.enter_context(unittest.mock.patch.dict(os.environ, {
            ...
            "HELION_AUTOTUNE_NUM_NEIGHBORS_CAP": "100",
            "HELION_CAP_REBENCHMARK_REPEAT": "100",
        }))
    ...
    def _init_process(self):
        ...
        self._exit_stack.enter_context(unittest.mock.patch.dict(_PROFILES,
            {"full": profile},
        ))
    ...
    def test_allreduce(self, autotuner):
        ...
        if autotuner == "fixed":
            ...
            kernel = helion.kernel(one_shot_allreduce_kernel, ignore_warnings=[helion.exc.TensorOperationInWrapper])
            context = unittest.mock.patch.dict(os.environ, {"HELION_AUTOTUNER": autotuner})
    ...
    @parametrize("autotuner", ["FiniteSearch"])
