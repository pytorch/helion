...
def _matmul_layernorm_kernel(x, y, weight, bias, out, out_stride_0, _BLOCK_SIZE_1: tl.constexpr, _RDIM_SIZE_0: tl.constexpr, _BLOCK_SIZE_2: tl.constexpr):
    ...
    var_mean_extra = tl.reshape(tl.sum(v_1, 1), [_BLOCK_SIZE_1, 1])
    v_2 = 400
    v_3 = var_mean_extra / v_2.to(tl.float32)
    v_4 = acc - v_3
    v_5 = v_4 * v_4
    v_6 = tl.where(tl.broadcast_to(mask_0[None, :], [_BLOCK_SIZE_1, _RDIM_SIZE_0]), v_5, 0)
    var_mean_extra_2 = tl.reshape(tl.sum(v_6, 1), [_BLOCK_SIZE_1, 1])
    v_7 = 400
    ...
    v_16 = load_3[None, :]
    v_17 = v_15 + v_16
    tl.store(out + (indices_1[:, None] * out_stride_0 + indices_0[None, :] * 1), v_17, mask_0[None, :])
...
def _matmul_layernorm_kernel(bias, x, y, weight, out, bias_size_0, bias_stride_0, out_stride_0, out_stride_1, weight_stride_0, x_stride_0, x_stride_1, y_stride_0, y_stride_1, m, k, _BLOCK_SIZE_1: tl.constexpr, _RDIM_SIZE_0: tl.constexpr, _BLOCK_SIZE_2: tl.constexpr):
    ...
    v_3 = acc - v_2
    v_4 = v_3 * v_3
    v_5 = tl.where(tl.broadcast_to(mask_0[None, :], [_BLOCK_SIZE_1, _RDIM_SIZE_0]), v_4, 0)
    var_mean_extra_2 = tl.reshape(tl.sum(v_5, 1), [_BLOCK_SIZE_1, 1])
    v_6 = var_mean_extra_2 / bias_size_0.to(tl.float32)
    v_7 = acc - v_2
    v_8 = 1e-05
    v_9 = v_6 + v_8
    ...
    v_14 = load_3[None, :]
    v_15 = v_13 + v_14
    tl.store(out + (indices_1[:, None] * out_stride_0 + indices_0[None, :] * out_stride_1), v_15, mask_1[:, None] & mask_0[None, :])
