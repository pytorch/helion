...
from helion._testing import skipIfA10G, skipIfRocm
...
class TestExamples(RefEagerTestBase, TestCase):
    ...
    def test_squeeze_and_excitation_net_bwd_dx(self):
        ...
        configured_kernel = helion.kernel(squeeze_and_excitation_net_fwd.fn, config=config)
        ...
        out_torch = torch.mul(x_torch, torch.sigmoid(torch.relu((x_torch @ a_torch)) @ b_torch))
