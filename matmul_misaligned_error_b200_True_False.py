...
# %%
@helion.kernel(config=helion.Config(block_sizes=[128, 16, 16], indexing='tensor_descriptor', l2_groupings=[8], loop_orders=[[1, 0]], num_stages=2, num_warps=4, pid_type='persistent_interleaved', range_flattens=[False, None], range_multi_buffers=[False, True], range_num_stages=[0, 2], range_unroll_factors=[0, 3], range_warp_specializes=[True, False]), static_shapes=True)
def matmul(
    x: Tensor,
    y: Tensor,
