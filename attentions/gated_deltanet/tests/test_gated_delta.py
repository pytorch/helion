...
_chunk_mod = _load_module("gated_delta_chunk", _kernels_path / "chunk.py")
_fused_recurrent_mod = _load_module("gated_delta_fused_recurrent", _kernels_path / "fused_recurrent.py")

chunk_gated_delta_rule = _chunk_mod.chunk_gated_delta_rule
fused_recurrent_gated_delta_rule = _fused_recurrent_mod.fused_recurrent_gated_delta_rule
