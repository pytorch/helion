...
# ==============================================================================
"""
Paged decode attention with CSR-style indexing (from SGLang).

This kernel implements flash decoding for paged KV cache using CSR-style
indexing (kv_indptr + kv_indices) instead of block tables.
