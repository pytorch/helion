...
# ==============================================================================
"""
Extend attention with CSR-style paged KV cache (from SGLang).

This kernel handles "extend" operations where new tokens are appended to
existing KV cache (chunked prefill / prefix caching). Uses CSR-style
indexing (kv_indptr + kv_indices) for paged access.
