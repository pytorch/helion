...
# ==============================================================================
"""
Prefill attention with varlen batching (from SGLang).

This kernel implements flash attention for prefill phase with variable-length
sequence batching. Uses b_start_loc and b_seq_len for varlen support.

Memory-efficient attention for prefill.
It supporst page size = 1.
Standalone version with inlined dependencies.
"""
