...
from fla_utils import IS_INTEL_ALCHEMIST, assert_close, device

# Use importlib to load modules to avoid sys.path conflicts
...
_kernels_path = Path(__file__).parent.parent / "kernels"
_chunk_mod = _load_module("kda_chunk", _kernels_path / "chunk.py")
_fused_recurrent_mod = _load_module("kda_fused_recurrent", _kernels_path / "fused_recurrent.py")
_gate_mod = _load_module("kda_gate", _kernels_path / "gate.py")
_naive_mod = _load_module("kda_naive", _kernels_path / "naive.py")

chunk_kda = _chunk_mod.chunk_kda
fused_recurrent_kda = _fused_recurrent_mod.fused_recurrent_kda
fused_recurrent_kda_fwd = _fused_recurrent_mod.fused_recurrent_kda_fwd
fused_kda_gate = _gate_mod.fused_kda_gate
naive_kda_gate = _gate_mod.naive_kda_gate
naive_kda_lowerbound_gate = _gate_mod.naive_kda_lowerbound_gate
naive_chunk_kda = _naive_mod.naive_chunk_kda
naive_recurrent_kda = _naive_mod.naive_recurrent_kda
