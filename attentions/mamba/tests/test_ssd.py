...
from ssd_combined import mamba_chunk_scan_combined, mamba_chunk_scan, ssd_chunk_scan_combined_ref
from ssd_combined import mamba_split_conv1d_scan_combined, mamba_split_conv1d_scan_ref
...
def test_chunk_state_varlen(chunk_size, ngroups, dtype):
    device = 'cuda'
    # bfloat16 has lower precision, so use higher tolerance
