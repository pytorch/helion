...
from fla_utils import assert_close, device, device_platform
...
_kernels_path = Path(__file__).parent.parent / "kernels" / "rwkv6"
_chunk_mod = _load_module("rwkv6_chunk", _kernels_path / "chunk.py")
_fused_recurrent_mod = _load_module("rwkv6_fused_recurrent", _kernels_path / "fused_recurrent.py")

chunk_rwkv6 = _chunk_mod.chunk_rwkv6
fused_recurrent_rwkv6 = _fused_recurrent_mod.fused_recurrent_rwkv6
