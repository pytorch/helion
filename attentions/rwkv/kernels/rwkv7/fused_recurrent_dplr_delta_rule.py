...
# Local implementation (replaces external fla.ops.generalized_delta_rule.dplr dependency)
...
from fla_utils import USE_CUDA_GRAPH, autocast_custom_bwd, autocast_custom_fwd, autotune_cache_kwargs, input_guard
from ops_utils import exp
