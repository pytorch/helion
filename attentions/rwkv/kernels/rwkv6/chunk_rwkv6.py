...
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent / "gla" / "kernels"))
...
from ops_utils import exp, prepare_chunk_indices, prepare_chunk_offsets

# Import from local gla kernels
from common.chunk_h import chunk_fwd_h

# Import from local GLA chunk - use importlib to avoid name conflict
_gla_chunk_path = Path(__file__).parent.parent.parent.parent / "gla" / "kernels" / "chunk_gla.py"
...
chunk_gla_bwd_dA = _gla_chunk.chunk_gla_bwd_dA
chunk_gla_bwd_dv = _gla_chunk.chunk_gla_bwd_dv
