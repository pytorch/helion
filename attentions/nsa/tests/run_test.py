...
def test_parallel_no_window():
    ...
    print(f"\nTesting NSA (no window): B={B}, T={T}, H={H}, HQ={HQ}, D={D}, S={S}, block_size={block_size}, window_size={window_size}")
...
if __name__ == "__main__":
    ...
    test_parallel_basic()
    test_parallel_no_window()
    print("\n\nAll NSA tests passed successfully!")
