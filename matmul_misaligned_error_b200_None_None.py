...
# %%
@helion.kernel(config=helion.Config(block_sizes=[64, 32, 32], indexing='block_ptr', l2_groupings=[64], loop_orders=[[0, 1]], num_stages=5, num_warps=4, pid_type='persistent_interleaved', range_flattens=[False, None], range_multi_buffers=[False, None], range_num_stages=[4, 4], range_unroll_factors=[0, 4], range_warp_specializes=[None, None]), static_shapes=True)
def matmul(
    x: Tensor,
    y: Tensor,
